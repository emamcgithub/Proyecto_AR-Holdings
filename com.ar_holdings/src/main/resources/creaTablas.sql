...
drop schema if exists Ar-Holdings;
drop user if exists usuario_prueba;
CREATE SCHEMA Ar-Holdings ;

/*Se crea un usuario para la base de datos llamado "usuario_prueba" y tiene la contraseña "Usuario_Clave."*/
create user 'usuario_prueba'@'%' identified by 'Usuar1o_Clave.';

/*Se asignan los prvilegios sobr ela base de datos Ar-Holdings al usuario creado */
grant all privileges on Ar-Holdings.* to 'usuario_prueba'@'%';
flush privileges;

/* la tabla de categoria contiene categorias de productos*/
create table Ar-Holdings.categoria (
...
create table Ar-Holdings.producto (
...
CREATE TABLE Ar-Holdings.usuario (
...
create table Ar-Holdings.factura (
...
create table Ar-Holdings.venta (
...
INSERT INTO Ar-Holdings.usuario (id_usuario, username,password,nombre, apellidos, correo, telefono,ruta_imagen,activo) VALUES 
...
INSERT INTO Ar-Holdings.categoria (id_categoria,descripcion,ruta_imagen,activo) VALUES 
...
INSERT INTO Ar-Holdings.producto (id_producto,id_categoria,descripcion,detalle,precio,existencias,ruta_imagen,activo) VALUES
...
INSERT INTO Ar-Holdings.factura (id_factura,id_usuario,fecha,total,estado) VALUES
...
INSERT INTO Ar-Holdings.venta (id_venta,id_factura,id_producto,precio,cantidad) values
(1,1,5,45000,3),
(2,1,9,15780,2),
(3,1,10,15000,3),
(4,2,5,45000,1),
...
insert into Ar-Holdings.rol (id_rol, nombre, id_usuario) values
